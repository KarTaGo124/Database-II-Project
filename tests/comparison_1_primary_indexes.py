...
Dataset: World Cities (41K records)
...
def main():
    ...
    print("="*70)
    print("Dataset: World Cities (~41K records)")
    ...
    print(f"  {'Index Type':<20} {'Avg Reads':<15} {'Avg Time (ms)'}")
    print(f"  {'-'*50}")
    for res in all_results:
        print(f"  {res['index_type']:<20} {res['search']['avg_reads']:<15.2f} {res['search']['avg_time_ms']:.2f}")
